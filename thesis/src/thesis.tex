...
i introduksjon, fortelle hva feature models er, hva det kan brukes til. ikke tekniske detaljer! engineering practice, software family. referanser. styrker. videre inn i planlegging, vanskelig. flere teams som må planlegge. hvordan hjelpe dette. gjenbruke kode.
scope: her modellerer jeg bare planlegging.
hvordan min oppgave skal leses.
...
forskningsspørsmål/mål. hva skal jeg undersøke/belyse. motivere, hvorfor gjør jeg det jeg gjør
konkrete spørsmål. how? what? in what way? type spm
hvordan formalisere endring?
hva er en god effektiv implementasjon?
fornuftig algoritme som tar hensyn til semantikk og struktur?
identifisere hva som er utfordringen.
3 stk ca.
for å addressere spm så må jeg se på følgende:
