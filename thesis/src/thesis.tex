...
A \textit{Software Product Line (SPL)} is a collection of closely-related \textit{software products}. The different software products in an SPL have several things in common, as well aspects that separate them \cite{cite:spl_practices_and_patterns, cite:spl_book}. As an software development paradigm, SPLs allows the engineers to model the softwares commonalities and variabilities to facilitate for large scale reuse.
