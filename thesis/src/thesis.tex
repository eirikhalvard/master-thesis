...
During the course of the LTEP project, we managed to get a paper published, \textit{Consistency-Preserving Evolution Planning on Feature Models} \cite{cite:consistency_preserving_evolution_planning}. In the paper, we presented methods for creating and retroactively adapting a feature model evolution plan while preventing structural and logical inconsistencies in the model. This was achieved by relying on structural operational semantics, linear temporal logic and rewriting logic for specification and implementation of the tool.

\todo{fit my thesis in the project}
 
While the work published in \cite{cite:consistency_preserving_evolution_planning} addresses some of the scientific aims of the LTEP project, some issues still remain. \todo{write}
