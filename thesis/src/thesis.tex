...
Software product lines (SPLs) model related closely related software systems by capitalizing on their similarities and differences. Software engineers explicitly encode the similarities and differences of an SPL by defining it in terms of a feature model. However, in order to ensure the long-term development, it is beneficial to not just capture the current software product line, but the planned evolution of the SPL as well.

Evolution planning of an SPL is often a dynamic, changing process, due to changing demands of the focus of development. In addition, the planning is typically not just done by a single engineer, but multiple engineers, often working separately and independent of each other. Due to these factors, the need to unify and synchronize the changes the evolution plan emerges.
