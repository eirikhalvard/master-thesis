...
\todo{problem definition. hva er det vi prøver å gjøre. blabla three-way fordi det er bedre. vi vil bevare structure og semantics.}
...
\section{The Three-Way Merge Algorithm}%
\label{sec:the_three_way_merge_algorithm}

\todo{the algorithm. how it works. outline. the different parts. the types of conflicts. bla bla}

\todo{fix headings and stuff!}
