...
Note that the visualization in Figure~\ref{fig:example1} of feature models are perhaps the most common across the research field. However, we will through the rest of this thesis use a slightly different notation for reasons we will explain in Section~\vref{sub:visual_representation}.
...
\todo{change to vref if possible}
