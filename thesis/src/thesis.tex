...
in Figure~\ref{fig:vending_machine_sound_base_ep}. A quick summary of all the changes for both derived versions can be seen in Table~\ref{tab:vending_machine_derived_changes}
