...
\begin{figure}[htpb]
  \centering
  \includegraphics[\linewidth]{simple_three_way_example.pdf}
  \caption{A simple example of three evolution plans ready for merging}%
...
Before attempting to merge the different versions, we want to detect what \textit{changes} has been made in both versions. 

\subsubsection{Interleaving Time Points}%
\label{ssub:interleaving_time_points}

bla bla bla, a version creating a new time point, union of all timePoints somehow
