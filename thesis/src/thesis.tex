...
\todo{something about the LTEP project}
\todo{something about summer project?}

\todo{written by other people? not necessarily. opptak, more personal. personal journey. what it means for me.} 
...
% Both TUBS and UiO have a body of preliminary work relevant for the project: TUBS has worked in constructing [S03,S02,S12,S11,S05,S04], maintaining [S21,S24,S02], evolving [S26,S23,S22,S17,S02,S07,S08] and reengineering [S27,S25,S18,S14,S10] SPLs. UiO has worked in creating formal models for cloud computing, object-oriented distributed systems as well as utilizing them for planning, simulation and analysis [Y12,Y10,Y09,Y08,Y02,Y01]. In addition, TUBS and UiO have already demonstrated their successful cooperation in previous joint publications [S26/Y11,S22/Y07,S19/Y05,S15/Y04,S06/Y03] and are now aiming to intensify this collaboration to collaboratively address the challenges of long-term evolution planning in SPLs.

\todo{section about the paper we published.}

\todo{fit my thesis in the project}

As the goal of the LTEP project is to devise a methodology for long-term evolution planning, we aimed for three scientific aims: (1) Provide collaborative evolution planning methods for variable systems, (2) Support dynamic changes to the evolution plan of variable systems, and (3) Harmonize partial evolution plans of multiple contributors. My work in this thesis concretely addresses the third aim.

% \todo{project desc:}
% \todo{use some of short summary of project to tell what letp is about. measure 6.} 
% \todo{background: site general papers. some sitations in the proj desc. to do with spl. selec cri 6. tubs has worked in constructing.}
% \todo{when i talk about ltep. in beginning a lot of work done in spl. ref ref. HOWEVER still lack of planing software evolution. in ltep we address this lack. collab with uni and uni. my work concretely adressess one of the challenges. merging plans of multiple contribs. citations will be about state of the art. funded by daad and nfr.}

\section{Research Questions}%
\label{sec:research_questions}

% \todo{research question: 3rd. is there any other approaches to. how to improve it? is there a better approach?} 
% \todo{pretend rqs are set before solution.}
% \todo{how do i create a merge tool that respect soundness.}
% \todo{how or what type rqs}
% \todo{what capabilities. how can we build this? type rqs. what degree, not jsut yes/no. invite discussion.}
% \todo{algorithm. soundness. my results.} 
% \todo{what algo can i use to. what data structure, what algo do i need to develop in order to be able to merge different plans taking into account ordering, challenges with algorithm. phrasing into a a discussion.}
...
\textbf{Chapter~\ref{cha:command_line_interface_and_visualization_tools}} outlines the tools supporting the core algorithm. Includes a command-line interface for automated interaction with existing tools as well as a tool for visualizing and exploring the merger.
