...
\begin{itemize}
  \item \textbf{Cause detection for conflicts}: \todo{write}
  \item \textbf{Constructing a version control system}: \todo{write}
  \item \textbf{Integration with current tools}: \todo{write}
\end{itemize}
