...
\paragraph{RQ1: How do we design an algorithm for merging evolution plans?}
...
\paragraph{RQ2: How do we create a merge tool for evolution plans that respect soundness?}
